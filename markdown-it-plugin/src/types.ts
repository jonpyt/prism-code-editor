...
export type PcePluginOptions = {
	...
	/**
	 * markdown-it's highlight function will add a trailing newline to fenced code blocks.
	 * This plugin removes this trailing newline by default, but this can be disabled by
	 * passing `false`.
	 *
	 * @default true
	 */
