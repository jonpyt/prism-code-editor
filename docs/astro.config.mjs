			...
			plugins: [
				...
				starlightTypeDoc({
					entryPoints: [
						...
						"../package/src/extensions/autocomplete/emmet/markup.ts",
						...
						"../package/src/extensions/hover.ts",
			...
			sidebar: [
				{
					...
					items: [
						...
						{ label: "Hotkeys", slug: "guides/hotkeys" },
						...
						{ label: "Pointer Events", slug: "guides/pointer-events" },
