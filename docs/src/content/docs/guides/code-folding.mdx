...
- [`bracketFolding(){:js}`](/api-reference/code-folding/v-bracketfolding) adds folding to round-, square-, and curly brackets.
- [`tagFolding(){:js}`](/api-reference/code-folding/v-tagfolding) adds folding to XML tags.
- [`blockCommentFolding(){:js}`](/api-reference/code-folding/v-blockcommentfolding) adds folding to block comments.
- [`markdownFolding(){:js}`](/api-reference/code-folding/v-markdownfolding) adds folding to headings and code blocks in markdown.
