...
React-pce v3.0 changed how editors and code blocks are passed to extensions. Now context is used, so they longer need to be explicitly passed to extensions.
