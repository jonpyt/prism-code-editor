---
title: Configuration
description: Learn how to configure the rehype plugin, markdown-it plugin, and marked extension.
---

import "../../../css/configuration.css"

This page will tell you which configuration options are available for the rehype plugin, markdown-it plugin, and marked extension.
...
markdown-it's highlight function and [`mdast-util-to-hast`](https://github.com/syntax-tree/mdast-util-to-hast/) will both add a trailing newline to fenced code blocks. These plugins remove this trailing newline by default, but this can be disabled by passing `false`. This option does not apply to the marked extension.
