...
In addition to all features described in the [code blocks guide](/guides/code-blocks), code blocks support adding extra classes to lines with properties wrapped in `{}`. This is intended for line highlighting.
